			...
			<td colspan="5" rowspan="1">
				...
				<ul>
					...
					<li>
						...
						For larger objects greater than 199MiB, multiple GET requests may be required to fully
						copy the object to R2.
					</li>
					<li>
						You could have multiple syncs if multiple users access the same file at the same time and it doesn't yet exist in R2.
					</li>
				</ul>
			</td>
		</tr>
